...
def main_form():
    ...
    # ℹ️ Oncotype DX Info Box
    st.markdown(
        """
        <div style='background-color:#fce4ec;padding:10px;border-radius:10px;margin-bottom:20px'>
        <strong>ℹ️ Don't have the score yet?</strong><br>
        The Oncotype DX score is a genomic test performed by a certified lab.  
        You can learn more or request the test at:  
        <a href="https://www.oncotypeiq.com/fr-fr/cancer-du-sein/professionnels-de-sante/oncotype-dx-breast-recurrence-score/comment-commander-le-test#"_blank">👉 Exact Sciences - Oncotype DX Info</a>
        </div>
        """,
        unsafe_allow_html=True
    )
